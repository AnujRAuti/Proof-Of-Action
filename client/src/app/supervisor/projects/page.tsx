    ...
    <div className="space-y-6">
      <div className="bg-surface border-2 border-border-hairline rounded-2xl p-6 shadow-subtle flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Link
          ...
          className="px-4 py-2.5 rounded-xl bg-india-green text-surface font-bold text-xs hover:bg-india-green/90 shadow-subtle flex items-center gap-2 self-start sm:self-center shrink-0"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {projects.map((project) => {
          ...
          return (
            <div
              key={project.id}
              className="bg-surface border-2 border-border-hairline rounded-2xl p-5 space-y-4 shadow-subtle flex flex-col justify-between hover:border-ink-muted transition-colors"
            >
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div className="space-y-1 min-w-0 flex-1">
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span className="text-[10px] font-bold text-india-green bg-india-green/10 px-2 py-0.5 rounded">
                        {project.status.replace('_', ' ')}
                      </span>
                    </div>

                    <h3 className="font-serif font-bold text-sm text-ink-primary leading-snug truncate">
                      {project.name}
                    </h3>
              ...
              <div className="pt-2 border-t border-border-hairline flex gap-2">
                <Link
                  ...
                  className="flex-1 py-2.5 rounded-xl bg-saffron text-ink-primary font-bold text-xs hover:bg-saffron-deep transition-colors text-center flex items-center justify-center gap-1.5 shadow-subtle"
                >
                ...
                <Link
                  ...
                  className="py-2.5 px-3 rounded-xl bg-surface-sunken hover:bg-surface border border-border-hairline text-ink-secondary text-xs font-semibold flex items-center justify-center gap-1"
                  title="Scan Photo"
                >
