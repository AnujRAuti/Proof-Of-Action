/**
 * Prisma database seed script for Proof-of-Action (EIIL).
 *
 * Populates:
 * 1. Demo users (Citizen, Supervisor, Reviewer) matching credentials.md
 * 2. 6 core government infrastructure projects with geofence centroids
 * 3. Evidence records, analyses, anomalies, duplicate links, and audit logs
 */
...
async function main() {
  console.log('🌱 Starting Proof-of-Action database seeding...');
