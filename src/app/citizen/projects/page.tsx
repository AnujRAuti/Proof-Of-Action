...
export default function CitizenPublicProjectsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Projects Grid (Public View: What, Where, Status, When Updated - Section 17) */}
          ...
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs font-bold text-india-green bg-india-green/10 px-2.5 py-0.5 rounded">
