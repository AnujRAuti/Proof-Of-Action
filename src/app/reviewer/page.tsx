...
export default function ReviewerOperationsPage() {
  ...
  const { evidenceList, projects, approveEvidence, flagEvidence, currentUser } = useApp();
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-[1440px] mx-auto space-y-6">
      ...
      {/* Main Grid: Urgent Flagged Items + Active Schemes */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Right 1 Col: Active Public Works Schemes */}
